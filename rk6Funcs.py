...
def firstVector(q, h, g, aVec, bVec):
    ...
    M1 = []
    K1.append(
        -1j * v(q * h) * bVec[0] - 1j * u(q * h) * aVec[0] - 1j * xmValsAll[0] * aVec[0] - 1j * g * np.abs(
            aVec[0]) ** 2 * bVec[0]
    )
    # n=1,...,N-1
    for n in range(1, N):
        K1.append(
            -1j * v(q * h) * bVec[n] - 1j * w(q * h) * bVec[n - 1] - 1j * u(q * h) * aVec[n] - 1j * xmValsAll[n] * aVec[
                n] \
    ...
    for n in range(0, N - 1):
        M1.append(
            -1j * v(q * h) * aVec[n] - 1j * w(q * h) * aVec[n + 1] + 1j * u(q * h) * bVec[n] - 1j * ymValsAll[n] * bVec[
                n] \
...
def thirdVector(q, h, g, aVec, bVec, K1, M1, K2, M2):
    ...
    for n in range(1, N):
        K3.append(
            ...
            * (bVec[n - 1] + 3 / 8 * h * M1[n - 1] + 1 / 8 * h * M2[n - 1] + bVec[n] + 3 / 8 * h * M1[n] + 1 / 8 * h *
               M2[n])
        )
    # n=0,...,N-2
    for n in range(0, N - 1):
        M3.append(
            ...
            * (aVec[n] + 3 / 8 * h * K1[n] + 1 / 8 * h * K2[n] + aVec[n + 1] + 3 / 8 * h * K1[n + 1] + 1 / 8 * h * K2[
                n + 1])
        )
    M3.append(
...
def sixthVector(q, h, g, aVec, bVec, K1, M1, K2, M2, K3, M3, K4, M4, K5, M5):
    ...
    K6.append(
        -1j * v(timeQuad) * (bVec[0] - (1155 + 255 * c) / 1960 * h * M1[0] - (280 + 40 * c) / 1960 * h * M2[0]
                             - 320 * c / 1960 * h * M3[0] + (63 + 363 * c) / 1960 * h * M4[0] + (
                                         2352 + 392 * c) / 1960 * h * M5[0]) \
        - 1j * u(timeQuad) * (aVec[0] - (1155 + 255 * c) / 1960 * h * K1[0] - (280 + 40 * c) / 1960 * h * K2[0]
                              - 320 * c / 1960 * h * K3[0] + (63 + 363 * c) / 1960 * h * K4[0] + (
                                          2352 + 392 * c) / 1960 * h * K5[0]) \
    ...
    for n in range(1, N):
        K6.append(
            -1j * v(timeQuad) * (bVec[n] - (1155 + 255 * c) / 1960 * h * M1[n] - (280 + 40 * c) / 1960 * h * M2[n]
                                 - 320 * c / 1960 * h * M3[n] + (63 + 363 * c) / 1960 * h * M4[n] + (
                                             2352 + 392 * c) / 1960 * h * M5[n]) \
            - 1j * w(timeQuad) * (
                        bVec[n - 1] - (1155 + 255 * c) / 1960 * h * M1[n - 1] - (280 + 40 * c) / 1960 * h * M2[n - 1]
                        - 320 * c / 1960 * h * M3[n - 1] + (63 + 363 * c) / 1960 * h * M4[n - 1] + (
                                    2352 + 392 * c) / 1960 * h * M5[n - 1]) \
            - 1j * u(timeQuad) * (aVec[n] - (1155 + 255 * c) / 1960 * h * K1[n] - (280 + 40 * c) / 1960 * h * K2[n]
                                  - 320 * c / 1960 * K3[n] + (63 + 363 * c) / 1960 * h * K4[n] + (
                                              2352 + 392 * c) / 1960 * h * K5[n]) \
            ...
            - 1j * g * np.abs(aVec[n] - (1155 + 255 * c) / 1960 * h * K1[n] - (280 + 40 * c) / 1960 * h * K2[n]
                              - 320 * c / 1960 * K3[n] + (63 + 363 * c) / 1960 * h * K4[n] + (
                                          2352 + 392 * c) / 1960 * h * K5[n]) ** 2 \
            * (bVec[n - 1] - (1155 + 255 * c) / 1960 * h * M1[n - 1] - (280 + 40 * c) / 1960 * h * M2[n - 1]
               - 320 * c / 1960 * h * M3[n - 1] + (63 + 363 * c) / 1960 * h * M4[n - 1] + (2352 + 392 * c) / 1960 * h *
               M5[n - 1]
    ...
    for n in range(0, N - 1):
        M6.append(
            -1j * v(timeQuad) * (aVec[n] - (1155 + 255 * c) / 1960 * h * K1[n] - (280 + 40 * c) / 1960 * h * K2[n]
                                 - 320 * c / 1960 * h * K3[n] + (63 + 363 * c) / 1960 * h * K4[n] + (
                                             2352 + 392 * c) / 1960 * h * K5[n]) \
            - 1j * w(timeQuad) * (
                        aVec[n + 1] - (1155 + 255 * c) / 1960 * h * K1[n + 1] - (280 + 40 * c) / 1960 * h * K2[n + 1]
                        - 320 * c / 1960 * h * K3[n + 1] + (63 + 363 * c) / 1960 * h * K4[n + 1] + (
                                    2352 + 392 * c) / 1960 * h * K5[n + 1]) \
    ...
    M6.append(
        ...
        - 1j * g * np.abs(bVec[N - 1] - (1155 + 255 * c) / 1960 * h * M1[N - 1] - (280 + 40 * c) / 1960 * h * M2[N - 1]
                          - 320 * c / 1960 * h * M3[N - 1] + (63 + 363 * c) / 1960 * h * M4[N - 1] + (
                                      2352 + 392 * c) / 1960 * h * M5[N - 1]) ** 2 \
        * (aVec[N - 1] - (1155 + 255 * c) / 1960 * h * K1[N - 1] - (280 + 40 * c) / 1960 * h * K2[N - 1]
           - 320 * c / 1960 * h * K3[N - 1] + (63 + 363 * c) / 1960 * h * K4[N - 1] + (2352 + 392 * c) / 1960 * h * K5[
               N - 1])
    )
    return K6, M6
...
def seventhVector(q, h, g, aVec, bVec, K1, M1, K2, M2, K3, M3, K4, M4, K5, M5, K6, M6):
    ...
    K7.append(
        -1j * v(timeQuad) * (
                    ...
                    + (126 - 189 * c) / 180 * h * M4[0] - (686 + 126 * c) / 180 * h * M5[0] + (490 - 70 * c) / 180 * h *
                    M6[0]) \
        - 1j * u(timeQuad) * (
                    aVec[0] + (330 + 105 * c) / 180 * h * K1[0] + 120 * h * K2[0] + (280 * c - 200) / 180 * h * K3[0]
                    + (126 - 189 * c) / 180 * h * K4[0] - (686 + 126 * c) / 180 * h * K5[0] + (490 - 70 * c) / 180 * h *
                    K6[0]) \
        - 1j * xmValsAll[0] * (
                    aVec[0] + (330 + 105 * c) / 180 * h * K1[0] + 120 * h * K2[0] + (280 * c - 200) / 180 * h * K3[0]
                    + (126 - 189 * c) / 180 * h * K4[0] - (686 + 126 * c) / 180 * h * K5[0] + (490 - 70 * c) / 180 * h *
        ...
        - 1j * g * np.abs(
            aVec[0] + (330 + 105 * c) / 180 * h * K1[0] + 120 * h * K2[0] + (280 * c - 200) / 180 * h * K3[0]
            + (126 - 189 * c) / 180 * h * K4[0] - (686 + 126 * c) / 180 * h * K5[0] + (490 - 70 * c) / 180 * h * K6[
                0]) ** 2 \
        * (bVec[0] + (330 + 105 * c) / 180 * h * M1[0] + 120 * h * M2[0] + (280 * c - 200) / 180 * h * M3[0]
    ...
    for n in range(1, N):
        K7.append(
            -1j * v(timeQuad) * (
                        bVec[n] + (330 + 105 * c) / 180 * h * M1[n] + 120 * h * M2[n] + (280 * c - 200) / 180 * h * M3[
                    n]
                        + (126 - 189 * c) / 180 * h * M4[n] - (686 + 126 * c) / 180 * h * M5[n] + (
                                    490 - 70 * c) / 180 * h * M6[n]) \
            - 1j * w(timeQuad) * (bVec[n - 1] + (330 + 105 * c) / 180 * h * M1[n - 1] + 120 * h * M2[n - 1] + (
                        280 * c - 200) / 180 * h * M3[n - 1]
                                  + (126 - 189 * c) / 180 * h * M4[n - 1] - (686 + 126 * c) / 180 * h * M5[n - 1] + (
                                              490 - 70 * c) / 180 * h * M6[n - 1]) \
            - 1j * u(timeQuad) * (
                        aVec[n] + (330 + 105 * c) / 180 * h * K1[n] + 120 * h * K2[n] + (280 * c - 200) / 180 * h * K3[
                    n]
                        + (126 - 189 * c) / 180 * h * K4[n] - (686 + 126 * c) / 180 * h * K5[n] + (
                                    490 - 70 * c) / 180 * h * K6[n]) \
            - 1j * xmValsAll[n] * (
                        aVec[n] + (330 + 105 * c) / 180 * h * K1[n] + 120 * h * K2[n] + (280 * c - 200) / 180 * h * K3[
                    n]
            ...
            - 1j * g * np.abs(
                ...
                + (126 - 189 * c) / 180 * h * K4[n] - (686 + 126 * c) / 180 * h * K5[n] + (490 - 70 * c) / 180 * h * K6[
                    n]) ** 2 \
            * (bVec[n - 1] + (330 + 105 * c) / 180 * h * M1[n - 1] + 120 * h * M2[n - 1] + (280 * c - 200) / 180 * h *
               M3[n - 1]
               + (126 - 189 * c) / 180 * h * M4[n - 1] - (686 + 126 * c) / 180 * h * M5[n - 1] + (
                           490 - 70 * c) / 180 * h * M6[n - 1]
               + bVec[n] + (330 + 105 * c) / 180 * h * M1[n] + 120 * h * M2[n] + (280 * c - 200) / 180 * h * M3[n]
               + (126 - 189 * c) / 180 * h * M4[n] - (686 + 126 * c) / 180 * h * M5[n] + (490 - 70 * c) / 180 * h * M6[
                   n])
        )
    # n=0,...,N-2
    for n in range(0, N - 1):
        M7.append(
            -1j * v(timeQuad) * (
                    ...
                    n]
                        + (126 - 189 * c) / 180 * h * K4[n] - (686 + 126 * c) / 180 * h * K5[n] + (
                                    490 - 70 * c) / 180 * h * K6[n]) \
            - 1j * w(timeQuad) * (aVec[n + 1] + (330 + 105 * c) / 180 * h * K1[n + 1] + 120 * h * K2[n + 1] + (
                        280 * c - 200) / 180 * h * K3[n + 1]
                                  + (126 - 189 * c) / 180 * h * K4[n + 1] - (686 + 126 * c) / 180 * h * K5[n + 1] + (
                                              490 - 70 * c) / 180 * h * K6[n + 1]) \
            + 1j * u(timeQuad) * (
                        bVec[n] + (330 + 105 * c) / 180 * h * M1[n] + 120 * h * M2[n] + (280 * c - 200) / 180 * h * M3[
                    n]
                        + (126 - 189 * c) / 180 * h * M4[n] - (686 + 126 * c) / 180 * h * M5[n] + (
            ...
            * (aVec[n] + (330 + 105 * c) / 180 * h * K1[n] + 120 * h * K2[n] + (280 * c - 200) / 180 * h * K3[n]
               + (126 - 189 * c) / 180 * h * K4[n] - (686 + 126 * c) / 180 * h * K5[n] + (490 - 70 * c) / 180 * h * K6[
                   n]
               + aVec[n + 1] + (330 + 105 * c) / 180 * h * K1[n + 1] + 120 * h * K2[n + 1] + (280 * c - 200) / 180 * h *
               K3[n + 1]
               + (126 - 189 * c) / 180 * h * K4[n + 1] - (686 + 126 * c) / 180 * h * K5[n + 1] + (
                           490 - 70 * c) / 180 * h * K6[n + 1])
        )
    M7.append(
        -1j * v(timeQuad) * (aVec[N - 1] + (330 + 105 * c) / 180 * h * K1[N - 1] + 120 * h * K2[N - 1] + (
                    280 * c - 200) / 180 * h * K3[N - 1]
                             + (126 - 189 * c) / 180 * h * K4[N - 1] - (686 + 126 * c) / 180 * h * K5[N - 1] + (
                                         490 - 70 * c) / 180 * h * K6[N - 1]) \
        + 1j * u(timeQuad) * (bVec[N - 1] + (330 + 105 * c) / 180 * h * M1[N - 1] + 120 * h * M2[N - 1] + (
                    280 * c - 200) / 180 * h * M3[N - 1]
                              + (126 - 189 * c) / 180 * h * M4[N - 1] - (686 + 126 * c) / 180 * h * M5[N - 1] + (
                                          490 - 70 * c) / 180 * h * M6[N - 1]) \
        - 1j * ymValsAll[N - 1] * (bVec[N - 1] + (330 + 105 * c) / 180 * h * M1[N - 1] + 120 * h * M2[N - 1] + (
                    280 * c - 200) / 180 * h * M3[N - 1]
                                   + (126 - 189 * c) / 180 * h * M4[N - 1] - (686 + 126 * c) / 180 * h * M5[N - 1] + (
                                               490 - 70 * c) / 180 * h * M6[N - 1]) \
        - 1j * g * np.abs(
            bVec[N - 1] + (330 + 105 * c) / 180 * h * M1[N - 1] + 120 * h * M2[N - 1] + (280 * c - 200) / 180 * h * M3[
                N - 1]
            + (126 - 189 * c) / 180 * h * M4[N - 1] - (686 + 126 * c) / 180 * h * M5[N - 1] + (490 - 70 * c) / 180 * h *
            M6[N - 1]) ** 2 \
        * (aVec[N - 1] + (330 + 105 * c) / 180 * h * K1[N - 1] + 120 * h * K2[N - 1] + (280 * c - 200) / 180 * h * K3[
            N - 1]
           + (126 - 189 * c) / 180 * h * K4[N - 1] - (686 + 126 * c) / 180 * h * K5[N - 1] + (490 - 70 * c) / 180 * h *
           K6[N - 1])
